  ...
  const handleLogOut = () =>{
    ...
    return (
        ...
        <div className="navbar">
          <a className="btn btn-ghost normal-case text-xl">Mobile Resale Point</a>
        </div>
        ...
        {user?.uid ?
      <>
      <button onClick={handleLogOut} className="btn btn-ghost btn-circle mx-2">Sign Out</button>
      </>
      :
      <>
          <button className="btn btn-ghost btn-circle mx-2">
