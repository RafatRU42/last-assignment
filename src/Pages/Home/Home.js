        ...
        <div>
			...
			<button className="inline-flex items-center px-20 py-14 rounded-lg dark:bg-orange-400 dark:text-gray-900">
				...
				<span className="flex flex-col items-start ml-4 leading-none">
					<h3 className='text-4xl font-bold text-white'>SAMSUNG</h3>
				</span>
			</button>
			<button className="inline-flex items-center px-20 py-14 rounded-lg dark:bg-green-400 text-white">
				...
				<span className="flex flex-col items-start ml-4 leading-none">
				<h3 className='text-4xl font-bold text-white'>VIVO</h3>
			...
			<button className="inline-flex items-center px-20 py-14 rounded-lg dark:bg-violet-400 text-white">
				...
				<span className="flex flex-col items-start ml-4 leading-none">
				<h3 className='text-4xl font-bold text-white'>iPhone</h3>
